...
namespace Asm {
	...
	public:
		...
		DataObject(D content, MemFun ser, MemFun2 deser, ThisPtr thisptr) : doSerialize([thisptr, ser](rapidjson::Value& value, rapidjson::Document::AllocatorType& allocator) { std::mem_fn(ser)(thisptr, value, allocator); }), doDeserialize([thisptr, deser](rapidjson::Value& value) { std::mem_fn(deser)(thisptr, value); }) {}
